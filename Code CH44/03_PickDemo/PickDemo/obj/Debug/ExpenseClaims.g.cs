...
namespace PickDemo {
    ...
    public partial class ExpenseClaims : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ExpenseClaims).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ExpenseClaims));
        ...
        private string FindResource() {
            string[] resources = typeof(ExpenseClaims).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ExpenseClaims.g.xaml") || resource.Equals("ExpenseClaims.g.xaml"))) {
                    return resource;
                }
            }
