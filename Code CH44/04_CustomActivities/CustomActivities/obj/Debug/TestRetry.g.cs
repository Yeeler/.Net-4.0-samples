...
namespace CustomActivities {
    ...
    public partial class TestRetry : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(TestRetry).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(TestRetry));
        ...
        private string FindResource() {
            string[] resources = typeof(TestRetry).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".TestRetry.g.xaml") || resource.Equals("TestRetry.g.xaml"))) {
                    return resource;
                }
            }
